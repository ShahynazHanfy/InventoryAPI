    ...
    public partial class db : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemStatusEmps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItemStatusEmps_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ItemStatusEmps_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemStatusEmps_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemStatusEmps_Statuses_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemStatusEmps_EmployeeId",
                table: "ItemStatusEmps",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemStatusEmps_ItemId",
                table: "ItemStatusEmps",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemStatusEmps_StatusId",
                table: "ItemStatusEmps",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemStatusEmps_UserId",
                table: "ItemStatusEmps",
                column: "UserId");
